   ...
   Loop
   {
      if GetKeyState("F", "P")
      {
         ...
         if (InStr(title, "Minecraft"))
         {
            ...
            MsgBox, This is not a Minecraft window. Close this message, click on Instance %n%, and press the F key after you have clicked on that instance.
      }
   }
}
...
EnterSingleplayer(n)
{
	...
	{
		DeleteOrMove(savesDirectories[n])
	}
   states[n] := "world list"
}

DeleteOrMove(savesDirectory)
{
